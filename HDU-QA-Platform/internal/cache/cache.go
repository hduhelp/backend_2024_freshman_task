...
// SetUserCacheInfo 将用户信息存入 Redis 缓存
...
// GetUserInfoFromCache 从 Redis 缓存中获取用户信息
...
// SetSessionInfo 将用户信息与会话字符串存入 Redis 缓存中
...
// GetSessionInfo 根据 session 从缓存中获取用户信息
...
// UpdateCachedUserInfo 再将新的用户信息更新到缓存
